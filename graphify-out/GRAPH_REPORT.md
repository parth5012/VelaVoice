# Graph Report - Vela Voice  (2026-07-26)

## Corpus Check
- 42 files · ~196,519 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1672 nodes · 4099 edges · 106 communities (100 shown, 6 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 262 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6db5737`
...
- [[_COMMUNITY_ggml_is_contiguous|ggml_is_contiguous]]
...
- [[_COMMUNITY_ggml_compute_forward_soft_max_back_f32|ggml_compute_forward_soft_max_back_f32]]
...
- [[_COMMUNITY_ggml_graph_plan|ggml_graph_plan]]
...
- [[_COMMUNITY_String|String]]
- [[_COMMUNITY_ggml_free|ggml_free]]
...
- [[_COMMUNITY_ggml_compute_forward_repeat_back_f32|ggml_compute_forward_repeat_back_f32]]
- [[_COMMUNITY_ggml_compute_forward_div_f32|ggml_compute_forward_div_f32]]
- [[_COMMUNITY_ggml_compute_forward_elu_f32|ggml_compute_forward_elu_f32]]
...
- `ggml_tallocr_free_tensor()` --calls--> `ggml_backend_buffer_get_alloc_size()`  [INFERRED]
  src/native/whisper/ggml-alloc.c → src/native/whisper/ggml-backend.c
- `ggml_tallocr_reset()` --calls--> `ggml_backend_buffer_get_size()`  [INFERRED]
  src/native/whisper/ggml-alloc.c → src/native/whisper/ggml-backend.c
...
Cohesion: 0.15
Nodes (15): InputMethodService, AudioRecord, Boolean, Button, ByteArray, Context, File, Int (+7 more)
...
Cohesion: 0.03
Nodes (91): float32x4_t, ggml_abs_inplace(), ggml_compute_forward_argmax(), ggml_compute_forward_argmax_f32(), ggml_compute_forward_concat(), ggml_compute_forward_concat_f32(), ggml_compute_forward_diag(), ggml_compute_forward_diag_f32() (+83 more)

### Community 3 - "WhisperEngine"
Cohesion: 0.16
Nodes (18): atomic_int, pthread_t, atomic_fetch_add(), atomic_fetch_sub(), atomic_load(), atomic_store(), LONG, clear_numa_thread_affinity() (+10 more)

### Community 4 - "App.tsx"
Cohesion: 0.29
Nodes (5): DEFAULT_MODELS, DictionaryEntry, getDb(), ModelInfo, ModelManager
...
Cohesion: 0.13
Nodes (19): ggml_compute_forward_acc(), ggml_compute_forward_acc_f32(), ggml_compute_forward_add(), ggml_compute_forward_add_f16_f16(), ggml_compute_forward_add_f16_f32(), ggml_compute_forward_add_f32(), ggml_compute_forward_add_q_f32(), ggml_compute_forward_alibi() (+11 more)
...
Cohesion: 0.10
Nodes (22): AccessibilityEvent, AccessibilityNodeInfo, AccessibilityService, Float, FrameLayout, GradientDrawable, AudioRecord, Boolean (+14 more)

### Community 9 - "dependencies"
Cohesion: 0.05
Nodes (25): byteswap(), byteswap_tensor(), byteswap_tensor_data(), ggml_tensor, read_safe(), whisper_context_default_params(), whisper_context_default_params_by_ref(), whisper_full_default_params() (+17 more)
...
Cohesion: 0.11
Nodes (11): Boolean, List, NativeModule, Promise, ReactApplicationContext, ReactContextBaseJavaModule, ReactPackage, ModelVerifierModule (+3 more)
...
Cohesion: 0.08
Nodes (28): ggml_compute_forward_abs(), ggml_compute_forward_abs_f32(), ggml_compute_forward_gelu(), ggml_compute_forward_gelu_f32(), ggml_compute_forward_gelu_quick(), ggml_compute_forward_gelu_quick_f32(), ggml_compute_forward_neg(), ggml_compute_forward_neg_f32() (+20 more)

### Community 23 - "Context"
Cohesion: 0.24
Nodes (11): jfloatArray, jlong, JNIEnv, JNIEXPORT, jobject, jstring, Java_com_velavoice_app_WhisperEngine_nativeFree(), Java_com_velavoice_app_WhisperEngine_nativeInit() (+3 more)

### Community 24 - "String"
Cohesion: 0.27
Nodes (6): FloatArray, Boolean, ByteArray, Long, String, WhisperEngine

### Community 25 - "View"
Cohesion: 0.18
Nodes (16): ggml_add_cast(), ggml_add_cast_impl(), ggml_are_same_shape(), ggml_compute_forward_add1(), ggml_compute_forward_add1_f16_f16(), ggml_compute_forward_add1_f16_f32(), ggml_compute_forward_add1_f32(), ggml_compute_forward_add1_q_f32() (+8 more)

### Community 26 - "ggml_compute_forward"
Cohesion: 0.09
Nodes (26): ggml_compute_forward(), ggml_compute_forward_argsort(), ggml_compute_forward_argsort_f32(), ggml_compute_forward_cont(), ggml_compute_forward_cpy(), ggml_compute_forward_cross_entropy_loss(), ggml_compute_forward_cross_entropy_loss_back(), ggml_compute_forward_diag_mask_f32() (+18 more)
...
Cohesion: 0.36
Nodes (5): Boolean, Context, File, String, TextCleaner
...
### Community 31 - "vector"
Cohesion: 0.10
Nodes (37): pair, decode_utf8(), dft(), fft(), get_signal_energy(), log_mel_spectrogram_worker_thread(), whisper_filters, data (+29 more)
...
Cohesion: 0.09
Nodes (36): sample_to_timestamp(), should_split_on_word(), timestamp_to_sample(), to_timestamp(), whisper_batch_prep_legacy(), whisper_decode(), whisper_decode_with_state(), whisper_encode_with_state() (+28 more)

### Community 34 - "ggml_dup_tensor"
Cohesion: 0.07
Nodes (55): ggml_add_rel_pos(), ggml_add_rel_pos_impl(), ggml_add_rel_pos_inplace(), ggml_alibi(), ggml_argsort(), ggml_calc_conv_output_size(), ggml_calc_conv_transpose_1d_output_size(), ggml_calc_conv_transpose_output_size() (+47 more)

### Community 35 - "whisper_decoder"
Cohesion: 0.09
Nodes (24): whisper_decoder, completed, failed, grammar, has_ts, i_batch, logits, logits_id (+16 more)

### Community 36 - "ggml_fp16_t"
Cohesion: 0.10
Nodes (26): __avx_f32cx8_load(), __avx_f32cx8_store(), ggml_fp16_t, __m128, __m256, ggml_compute_forward_conv_transpose_2d(), ggml_compute_forward_flash_ff(), ggml_compute_forward_flash_ff_f16() (+18 more)
...
Cohesion: 0.12
Nodes (34): ggml_acc(), ggml_acc_impl(), ggml_acc_inplace(), ggml_acc_or_set(), ggml_add(), ggml_compute_backward(), ggml_cont(), ggml_cpy() (+26 more)
...
Cohesion: 0.15
Nodes (25): ggml_opt_callback, ggml_backend_cpu_graph_compute(), ggml_backend_cpu_graph_plan_compute(), ggml_compute_forward_soft_max_back(), ggml_compute_forward_soft_max_back_f32(), ggml_cycles(), ggml_cycles_per_ms(), ggml_get_f32_1d() (+17 more)

### Community 48 - "ggml_new_graph_custom"
Cohesion: 0.15
Nodes (20): ggml_build_backward_expand(), ggml_build_backward_gradient_checkpointing(), ggml_build_forward_expand(), ggml_build_forward_impl(), ggml_graph_clear(), ggml_graph_cpy(), ggml_graph_dup(), ggml_graph_nbytes() (+12 more)
...
Cohesion: 0.17
Nodes (17): ggml_backend_buffer_context_t, ggml_backend_buffer_type_t, ggml_backend_buffer_get_alignment(), ggml_backend_buffer_init(), ggml_backend_buffer_is_host(), ggml_backend_buffer_type(), ggml_backend_buft_get_alignment(), ggml_backend_buft_is_host() (+9 more)
...
Cohesion: 0.18
Nodes (13): ggml_argmax(), ggml_compute_forward_out_prod(), ggml_compute_forward_out_prod_f32(), ggml_compute_forward_out_prod_q_f32(), ggml_cross_entropy_loss(), ggml_is_matrix(), ggml_new_f32(), ggml_new_i32() (+5 more)

### Community 56 - "whisper_context"
Cohesion: 0.16
Nodes (18): ggml_backend_buffer_t, ggml_backend_alloc_buffer(), ggml_backend_buffer_clear(), ggml_backend_buffer_get_alloc_size(), ggml_backend_buffer_get_base(), ggml_backend_buffer_get_size(), ggml_backend_buffer_init_tensor(), ggml_backend_buft_alloc_buffer() (+10 more)

### Community 57 - "Java_com_velavoice_app_WhisperEngine_nativeTranscribe"
Cohesion: 0.18
Nodes (15): ggml_are_same_layout(), ggml_backend_cpu_buffer_cpy_tensor_from(), ggml_backend_cpu_buffer_cpy_tensor_to(), ggml_backend_tensor_copy(), ggml_backend_tensor_get(), ggml_backend_tensor_get_async(), ggml_backend_tensor_set(), ggml_backend_tensor_set_async() (+7 more)

### Community 58 - "ggml_add1_impl"
Cohesion: 0.18
...
### Community 61 - "size"
Cohesion: 0.13
Nodes (17): hann_window(), log_mel_spectrogram(), tokenize(), whisper_full_n_segments_from_state(), whisper_full_n_tokens(), whisper_full_n_tokens_from_state(), size, whisper_mel (+9 more)
...
Cohesion: 0.17
Nodes (13): ggml_can_repeat(), ggml_can_repeat_rows(), ggml_compute_forward_repeat(), ggml_compute_forward_repeat_f16(), ggml_compute_forward_repeat_f32(), ggml_div(), ggml_div_impl(), ggml_div_inplace() (+5 more)

### Community 65 - "ggml_nbytes"
Cohesion: 0.33
...
Cohesion: 0.38
Nodes (7): ggml_tensor, ggml_cont_1d(), ggml_cont_2d(), ggml_cont_3d(), ggml_cont_4d(), ggml_conv_1d(), ggml_conv_1d_ph()

### Community 67 - "ggml_is_contiguous"
Cohesion: 0.21
Nodes (25): ggml_blck_size(), ggml_compute_forward_dup_bytes(), ggml_compute_forward_dup_f16(), ggml_compute_forward_dup_f32(), ggml_compute_forward_dup_same_cont(), ggml_compute_forward_get_rows_back(), ggml_compute_forward_get_rows_back_f32(), ggml_compute_forward_get_rows_back_f32_f16() (+17 more)
...
Cohesion: 0.40
Nodes (5): ggml_compute_forward_get_rows(), ggml_compute_forward_get_rows_f16(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_get_rows_q(), ggml_fp16_to_fp32_row()

### Community 70 - "ggml_vec_dot_q6_K_q8_K"
Cohesion: 0.18
Nodes (24): ggml_backend_graph_plan_t, ggml_type_traits_t, ggml_backend_t, ggml_backend_cpu_buffer_type_supports_backend(), ggml_backend_cpu_free(), ggml_backend_cpu_graph_plan_create(), ggml_backend_cpu_graph_plan_free(), ggml_backend_cpu_init() (+16 more)

### Community 71 - "ggml_compute_forward_soft_max_back_f32"
Cohesion: 0.19
Nodes (15): ggml_compute_forward_mul_mat_use_blas(), ggml_get_n_tasks(), ggml_get_op_params_i32(), ggml_get_unary_op(), ggml_graph_export(), ggml_graph_export_leaf(), ggml_graph_export_node(), ggml_graph_plan() (+7 more)
...
### Community 74 - "ggml_init"
Cohesion: 0.09
Nodes (27): ggml_type, mt19937, fill_sin_cos_table(), whisper_allocr_size(), whisper_backend_init(), whisper_batch_init(), whisper_build_graph_conv(), whisper_context (+19 more)
...
Cohesion: 0.24
Nodes (10): ggml_backend_eval_callback, ggml_backend_compare_graph_backend(), ggml_backend_graph_copy(), ggml_dup_tensor_layout(), graph_dup_tensor(), graph_init_tensor(), ggml_graph_view(), ggml_hash() (+2 more)
...
### Community 83 - "ggml_graph_plan"
Cohesion: 0.17
Nodes (13): GGML_API, ggml_gelu_f32(), ggml_gelu_quick_f32(), ggml_graph_reset(), ggml_init(), ggml_opt(), ggml_opt_init(), ggml_set_zero() (+5 more)

### Community 84 - "ggml_rope_impl"
Cohesion: 0.15
Nodes (13): ggml_add1(), ggml_add1_impl(), ggml_add1_inplace(), ggml_add1_or_set(), ggml_add_impl(), ggml_add_inplace(), ggml_add_or_set(), ggml_get_name() (+5 more)

### Community 85 - "ggml_set_f32_1d"
Cohesion: 0.67
Nodes (3): ggml_compute_forward_log(), ggml_compute_forward_log_f32(), ggml_vec_log_f32()

### Community 86 - "whisper_batch"
Cohesion: 0.23
Nodes (12): FILE, ggml_graph_dump_dot(), ggml_graph_dump_dot_leaf_edge(), ggml_graph_dump_dot_node_edge(), ggml_graph_find(), ggml_graph_get_parent(), ggml_op_symbol(), gguf_fread_el() (+4 more)

### Community 88 - "ggml_add_rel_pos_impl"
Cohesion: 0.67
Nodes (3): ggml_compute_forward_sub(), ggml_compute_forward_sub_f32(), ggml_vec_sub_f32()

### Community 91 - "ggml_free"
Cohesion: 0.27
Nodes (11): ggml_backend_buffer_free(), ggml_backend_free(), ggml_backend_graph_copy_free(), ggml_critical_section_end(), ggml_free(), ggml_used_mem(), kv_cache_free(), whisper_allocr_free() (+3 more)

### Community 92 - "whisper_bench_ggml_mul_mat_str"
Cohesion: 0.33
Nodes (9): ggml_time_init(), ggml_time_us(), whisper_bench_ggml_mul_mat(), whisper_bench_ggml_mul_mat_str(), whisper_bench_memcpy(), whisper_bench_memcpy_str(), whisper_print_timings(), whisper_reset_timings() (+1 more)

### Community 93 - "ggml_set_f32_1d"
Cohesion: 0.25
Nodes (8): ggml_get_i32_1d(), ggml_get_i32_nd(), ggml_opt_set_params(), ggml_set_f32_1d(), ggml_set_f32_nd(), ggml_set_i32_1d(), ggml_set_i32_nd(), ggml_unravel_index()

### Community 94 - "ggml_set_impl"
Cohesion: 0.29
...
### Community 96 - "ggml_map_custom1_impl_f32"
Cohesion: 0.60
...
### Community 97 - "ggml_dup_impl"
Cohesion: 0.06
Nodes (37): ggml_custom2_op_t, ggml_custom3_op_f32_t, ggml_custom3_op_t, ggml_compute_forward_map_custom3_f32(), ggml_cont_impl(), ggml_cont_inplace(), ggml_diag_mask_zero(), ggml_diag_mask_zero_impl() (+29 more)

### Community 98 - "ggml_compute_forward_repeat_back_f32"
Cohesion: 0.40
Nodes (5): ggml_compute_forward_repeat_back(), ggml_compute_forward_repeat_back_f32(), ggml_compute_forward_rms_norm_back(), ggml_compute_forward_rms_norm_back_f32(), ggml_vec_acc_f32()

### Community 100 - "ggml_compute_forward_div_f32"
Cohesion: 0.67
Nodes (3): ggml_compute_forward_div(), ggml_compute_forward_div_f32(), ggml_vec_div_f32()

### Community 101 - "ggml_compute_forward_elu_f32"
Cohesion: 0.67
Nodes (3): ggml_compute_forward_elu(), ggml_compute_forward_elu_f32(), ggml_vec_elu_f32()

### Community 102 - "ggml_compute_forward_sqr_f32"
Cohesion: 0.67
Nodes (3): ggml_compute_forward_sqr(), ggml_compute_forward_sqr_f32(), ggml_vec_sqr_f32()

## Knowledge Gaps
- **279 isolated node(s):** `Recording`, `styles`, `name`, `slug`, `version` (+274 more)
...
- **Why does `whisper_build_graph_decoder()` connect `ggml_compute_backward` to `whisper_state`, `ggml_dup_tensor`, `ggml_is_contiguous`, `ggml-alloc.c`, `dependencies`, `ggml_init`, `ggml_new_graph_custom`, `ggml_graph_plan`, `whisper_batch`, `ggml_quantize_chunk`, `Java_com_velavoice_app_WhisperEngine_nativeTranscribe`, `ggml_free`, `size`, `vector`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `whisper_state` connect `whisper_state` to `whisper_full_with_state`, `whisper_decoder`, `dependencies`, `ggml_init`, `ggml_compute_backward`, `whisper_kv_cache`, `whisper_batch`, `ggml_add1_impl`, `ggml-alloc.c`, `vector`, `size`, `ggml_backend_alloc_ctx_tensors_from_buft`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `whisper_build_graph_encoder()` connect `ggml_compute_backward` to `whisper_state`, `ggml_dup_impl`, `ggml_dup_tensor`, `ggml_is_contiguous`, `dependencies`, `ggml_init`, `ggml_new_graph_custom`, `ggml_graph_plan`, `ggml_free`, `size`, `vector`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **What connects `Recording`, `styles`, `name` to the rest of the system?**
  _279 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `package.json` be split into smaller, more focused modules?**
  _Cohesion score 0.07407407407407407 - nodes in this community are weakly interconnected._
- **Should `ModelVerifierModule` be split into smaller, more focused modules?**
  _Cohesion score 0.027089671157467767 - nodes in this community are weakly interconnected._
- **Should `WaveformView` be split into smaller, more focused modules?**
