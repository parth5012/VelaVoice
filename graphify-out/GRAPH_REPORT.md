...
## Corpus Check
- 37 files · ~154,230 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1571 nodes · 3983 edges · 90 communities (89 shown, 1 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 266 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cce6ef7f`
...
Cohesion: 0.06
Nodes (32): AudioRecord, Button, ByteArray, Canvas, EditorInfo, FloatArray, GradientDrawable, InputMethodService (+24 more)
...
Cohesion: 0.03
Nodes (65): float32x4_t, ggml_abs_inplace(), ggml_compute_forward_argmax(), ggml_compute_forward_argmax_f32(), ggml_compute_forward_concat(), ggml_compute_forward_concat_f32(), ggml_compute_forward_diag(), ggml_compute_forward_diag_f32() (+57 more)

### Community 3 - "WhisperEngine"
Cohesion: 0.17
Nodes (17): atomic_int, pthread_t, atomic_fetch_add(), atomic_fetch_sub(), atomic_load(), atomic_store(), LONG, clear_numa_thread_affinity() (+9 more)
...
Cohesion: 0.18
Nodes (21): ggml_opt_callback, ggml_backend_cpu_graph_plan_compute(), ggml_cycles(), ggml_get_f32_1d(), ggml_get_f32_nd(), ggml_graph_compute(), ggml_graph_compute_with_ctx(), ggml_graph_reset() (+13 more)
...
Cohesion: 0.12
Nodes (22): ggml_compute_forward_flash_attn(), ggml_compute_forward_flash_attn_back(), ggml_compute_forward_flash_attn_back_f32(), ggml_compute_forward_flash_attn_f16(), ggml_compute_forward_flash_attn_f32(), ggml_compute_forward_group_norm(), ggml_compute_forward_group_norm_f32(), ggml_compute_forward_mean() (+14 more)

### Community 9 - "dependencies"
Cohesion: 0.04
Nodes (38): ggml_backend_buffer_free(), ggml_backend_free(), fill_sin_cos_table(), kv_cache_free(), whisper_allocr_free(), whisper_batch_free(), whisper_batch_init(), whisper_context_default_params() (+30 more)
...
Cohesion: 0.11
Nodes (11): List, NativeModule, Promise, ReactApplicationContext, ReactContextBaseJavaModule, ReactPackage, Boolean, String (+3 more)

### Community 21 - "String"
Cohesion: 0.09
Nodes (25): ggml_set_name(), ggml_set_no_alloc(), gguf_find_key(), gguf_free(), gguf_get_arr_data(), gguf_get_arr_n(), gguf_get_arr_str(), gguf_get_arr_type() (+17 more)

### Community 22 - "App.tsx"
Cohesion: 0.20
Nodes (17): ggml_compute_forward_get_rows_q(), ggml_conv_1d(), ggml_conv_1d_ph(), ggml_conv_2d(), ggml_conv_2d_s1_ph(), ggml_conv_2d_sk_p0(), ggml_cpy_impl(), ggml_cpy_inplace() (+9 more)
...
### Community 25 - "View"
Cohesion: 0.14
Nodes (18): ggml_compute_forward_acc(), ggml_compute_forward_acc_f32(), ggml_compute_forward_add(), ggml_compute_forward_add_f16_f16(), ggml_compute_forward_add_f16_f32(), ggml_compute_forward_add_f32(), ggml_compute_forward_add_q_f32(), ggml_compute_forward_alibi() (+10 more)

### Community 26 - "ggml_compute_forward"
Cohesion: 0.09
Nodes (26): ggml_compute_forward(), ggml_compute_forward_argsort(), ggml_compute_forward_argsort_f32(), ggml_compute_forward_clamp(), ggml_compute_forward_clamp_f32(), ggml_compute_forward_cont(), ggml_compute_forward_cpy(), ggml_compute_forward_diag_mask_f32() (+18 more)

### Community 27 - "ggml-alloc.c"
Cohesion: 0.07
Nodes (66): function, ggml_allocr_t, ggml_gallocr_t, ggml_type, add_allocated_tensor(), aligned_offset(), allocate_node(), ggml_tallocr_t (+58 more)

### Community 28 - "ggml_are_same_shape"
Cohesion: 0.09
Nodes (31): ggml_are_same_shape(), ggml_compute_forward_abs(), ggml_compute_forward_abs_f32(), ggml_compute_forward_elu(), ggml_compute_forward_elu_f32(), ggml_compute_forward_gelu(), ggml_compute_forward_gelu_f32(), ggml_compute_forward_gelu_quick() (+23 more)
...
### Community 31 - "vector"
Cohesion: 0.14
Nodes (26): pair, decode_utf8(), whisper_grammar, whisper_grammar_accept(), whisper_grammar_accept_token(), whisper_grammar_advance_stack(), whisper_grammar_candidate, code_points (+18 more)
...
Cohesion: 0.08
Nodes (47): ggml_add_rel_pos(), ggml_add_rel_pos_impl(), ggml_add_rel_pos_inplace(), ggml_argmax(), ggml_argsort(), ggml_calc_conv_output_size(), ggml_calc_conv_transpose_1d_output_size(), ggml_calc_conv_transpose_output_size() (+39 more)

### Community 35 - "whisper_decoder"
Cohesion: 0.09
Nodes (25): mt19937, whisper_decoder, completed, failed, grammar, has_ts, i_batch, logits (+17 more)

### Community 36 - "ggml_fp16_t"
Cohesion: 0.15
Nodes (17): __avx_f32cx8_load(), __avx_f32cx8_store(), ggml_fp16_t, __m128, __m256, ggml_compute_forward_conv_transpose_2d(), ggml_compute_forward_flash_ff(), ggml_compute_forward_flash_ff_f16() (+9 more)

### Community 37 - "ggml_backend_t"
Cohesion: 0.17
Nodes (24): ggml_backend_graph_plan_t, ggml_type_traits_t, ggml_backend_t, fmt_size(), ggml_backend_cpu_buffer_type_supports_backend(), ggml_backend_cpu_free(), ggml_backend_cpu_graph_plan_create(), ggml_backend_cpu_graph_plan_free() (+16 more)
...
Cohesion: 0.29
Nodes (15): ggml_add(), ggml_cpy(), ggml_element_size(), ggml_mul_mat(), ggml_new_tensor_3d(), ggml_norm(), ggml_soft_max(), ggml_view_1d() (+7 more)
...
Cohesion: 0.25
Nodes (19): ggml_backend_sched_t, ggml_tallocr_t, get_allocr_backend(), get_buffer_backend(), ggml_backend_name(), ggml_backend_sched_get_buffer(), ggml_backend_sched_get_tallocr(), ggml_backend_sched_graph_compute() (+11 more)
...
Cohesion: 0.18
Nodes (17): FILE, ggml_graph_dump_dot(), ggml_graph_dump_dot_leaf_edge(), ggml_graph_dump_dot_node_edge(), ggml_graph_export(), ggml_graph_export_leaf(), ggml_graph_export_node(), ggml_graph_find() (+9 more)

### Community 48 - "ggml_new_graph_custom"
Cohesion: 0.16
Nodes (15): ggml_build_backward_expand(), ggml_build_backward_gradient_checkpointing(), ggml_build_forward_impl(), ggml_cycles_per_ms(), ggml_get_name(), ggml_graph_clear(), ggml_graph_cpy(), ggml_graph_print() (+7 more)
...
Cohesion: 0.10
Nodes (25): ggml_float, ggml_compute_forward_add1(), ggml_compute_forward_add1_f16_f16(), ggml_compute_forward_add1_f16_f32(), ggml_compute_forward_add1_f32(), ggml_compute_forward_add1_q_f32(), ggml_compute_forward_cross_entropy_loss(), ggml_compute_forward_cross_entropy_loss_f32() (+17 more)
...
Cohesion: 0.17
Nodes (17): ggml_compute_forward_out_prod(), ggml_compute_forward_out_prod_f32(), ggml_compute_forward_out_prod_q_f32(), ggml_compute_forward_repeat_back(), ggml_compute_forward_repeat_back_f32(), ggml_new_f32(), ggml_new_i32(), ggml_scratch_load() (+9 more)
...
Cohesion: 0.07
Nodes (36): ggml_abs(), ggml_acc(), ggml_acc_impl(), ggml_acc_inplace(), ggml_acc_or_set(), ggml_add1_or_set(), ggml_add_impl(), ggml_add_inplace() (+28 more)

### Community 61 - "size"
Cohesion: 0.14
Nodes (22): dft(), fft(), get_signal_energy(), hann_window(), log_mel_spectrogram(), log_mel_spectrogram_worker_thread(), tokenize(), whisper_allocr_size() (+14 more)
...
Cohesion: 0.13
Nodes (16): ggml_add_cast(), ggml_add_cast_impl(), ggml_can_repeat(), ggml_can_repeat_rows(), ggml_compute_forward_repeat(), ggml_compute_forward_repeat_f16(), ggml_compute_forward_repeat_f32(), ggml_div() (+8 more)

### Community 65 - "ggml_nbytes"
Cohesion: 0.20
Nodes (14): ggml_are_same_layout(), ggml_backend_cpu_buffer_cpy_tensor_from(), ggml_backend_cpu_buffer_cpy_tensor_to(), ggml_backend_tensor_copy(), ggml_backend_tensor_get(), ggml_backend_tensor_get_async(), ggml_backend_tensor_set(), ggml_backend_tensor_set_async() (+6 more)
...
Cohesion: 0.32
Nodes (14): ggml_blck_size(), ggml_compute_forward_dup_bytes(), ggml_compute_forward_dup_f16(), ggml_compute_forward_dup_f32(), ggml_compute_forward_dup_same_cont(), ggml_compute_forward_get_rows_back(), ggml_compute_forward_get_rows_back_f32(), ggml_compute_forward_get_rows_back_f32_f16() (+6 more)
...
Cohesion: 0.39
Nodes (9): ggml_gelu(), ggml_graph_compute_helper(), whisper_build_graph_conv(), whisper_decode_internal(), whisper_encode_external(), whisper_encode_internal(), data, whisper_init_state() (+1 more)

### Community 70 - "ggml_vec_dot_q6_K_q8_K"
Cohesion: 0.16
Nodes (17): ggml_backend_buffer_t, ggml_backend_buffer_clear(), ggml_backend_buffer_get_alloc_size(), ggml_backend_buffer_get_base(), ggml_backend_buffer_get_size(), ggml_backend_buffer_init_tensor(), ggml_backend_buft_alloc_buffer(), ggml_backend_buft_get_alloc_size() (+9 more)

### Community 71 - "ggml_compute_forward_soft_max_back_f32"
Cohesion: 0.18
Nodes (12): ggml_compute_forward_get_rows(), ggml_compute_forward_get_rows_f16(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_rms_norm_back(), ggml_compute_forward_rms_norm_back_f32(), ggml_compute_forward_set(), ggml_compute_forward_set_f32(), ggml_compute_forward_soft_max() (+4 more)
...
Cohesion: 0.13
Nodes (22): GGML_API, ggml_critical_section_end(), ggml_free(), ggml_gelu_f32(), ggml_gelu_quick_f32(), ggml_init(), ggml_new_tensor_2d(), ggml_opt() (+14 more)
...
Cohesion: 0.24
Nodes (11): ggml_build_forward_expand(), ggml_graph_dup(), ggml_graph_import(), ggml_graph_nbytes(), ggml_graph_overhead(), ggml_graph_overhead_custom(), ggml_hash_size(), ggml_new_graph() (+3 more)

### Community 80 - "ggml_map_custom1_impl_f32"
Cohesion: 0.24
Nodes (10): ggml_backend_eval_callback, ggml_backend_compare_graph_backend(), ggml_backend_graph_copy(), ggml_backend_graph_copy_free(), ggml_dup_tensor_layout(), graph_dup_tensor(), graph_init_tensor(), ggml_graph_view() (+2 more)
...
Cohesion: 0.08
Nodes (40): ggml_custom1_op_t, ggml_custom2_op_t, ggml_custom3_op_f32_t, ggml_custom3_op_t, ggml_add1(), ggml_add1_impl(), ggml_add1_inplace(), ggml_alibi() (+32 more)

### Community 83 - "ggml_graph_plan"
Cohesion: 0.32
Nodes (8): ggml_backend_cpu_graph_compute(), ggml_compute_forward_mul_mat_use_blas(), ggml_get_n_tasks(), ggml_get_op_params_i32(), ggml_get_unary_op(), ggml_graph_plan(), ggml_op_desc(), ggml_unary_op_name()
...
Cohesion: 0.40
Nodes (5): ggml_compute_forward_cross_entropy_loss_back(), ggml_compute_forward_cross_entropy_loss_back_f32(), ggml_compute_forward_sub(), ggml_compute_forward_sub_f32(), ggml_vec_sub_f32()

## Knowledge Gaps
- **232 isolated node(s):** `styles`, `name`, `slug`, `version`, `package` (+227 more)
...
- **Why does `whisper_build_graph_decoder()` connect `ggml_view_tensor` to `ggml_can_repeat`, `ggml_nbytes`, `ggml_dup_tensor`, `whisper_state`, `whisper_global`, `dependencies`, `ggml_init`, `quantize_row_q5_0_reference`, `ggml_map_custom3_impl_f32`, `whisper_batch`, `App.tsx`, `whisper_context`, `ggml-alloc.c`, `ggml_unary`, `size`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `whisper_state` connect `whisper_state` to `whisper_full_with_state`, `whisper_decoder`, `whisper_global`, `ggml_view_tensor`, `dependencies`, `whisper_kv_cache`, `ggml-impl.h`, `whisper_batch`, `whisper_context`, `ggml-alloc.c`, `size`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ggml_time_us()` connect `ggml_init` to `whisper_full_with_state`, `ModelVerifierModule`, `whisper_global`, `WaveformView`, `dependencies`, `sched_split_graph`, `ggml-alloc.c`, `size`?**
...
- **Should `ModelVerifierModule` be split into smaller, more focused modules?**
  _Cohesion score 0.03201146679407549 - nodes in this community are weakly interconnected._