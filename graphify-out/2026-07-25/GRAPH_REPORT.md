...
## Corpus Check
- 37 files · ~153,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1554 nodes · 3947 edges · 100 communities (98 shown, 2 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 266 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3be10ba7`
...
- [[_COMMUNITY_whisper_allocr|whisper_allocr]]
...
- [[_COMMUNITY_ggml_build_forward_impl|ggml_build_forward_impl]]
- [[_COMMUNITY_ggml_diag_mask_inf_impl|ggml_diag_mask_inf_impl]]
...
- [[_COMMUNITY_ggml_rms_norm_impl|ggml_rms_norm_impl]]
...
Cohesion: 0.07
Nodes (25): AudioRecord, Button, ByteArray, Canvas, Float, FloatArray, InputMethodService, LinearLayout (+17 more)
...
Cohesion: 0.04
Nodes (29): ggml_acc(), ggml_acc_inplace(), ggml_add_inplace(), ggml_calc_conv_output_size(), ggml_calc_conv_transpose_1d_output_size(), ggml_calc_conv_transpose_output_size(), ggml_can_out_prod(), ggml_cont_inplace() (+21 more)

### Community 3 - "WhisperEngine"
Cohesion: 0.18
Nodes (17): atomic_int, pthread_t, atomic_fetch_add(), atomic_fetch_sub(), atomic_load(), atomic_store(), LONG, ggml_critical_section_end() (+9 more)
...
Cohesion: 0.14
Nodes (24): GGML_API, ggml_opt_callback, ggml_cycles(), ggml_cycles_per_ms(), ggml_get_name(), ggml_graph_compute(), ggml_graph_compute_with_ctx(), ggml_graph_print() (+16 more)
...
Cohesion: 0.08
Nodes (36): ggml_compute_forward_cross_entropy_loss(), ggml_compute_forward_cross_entropy_loss_back(), ggml_compute_forward_cross_entropy_loss_back_f32(), ggml_compute_forward_cross_entropy_loss_f32(), ggml_compute_forward_flash_attn(), ggml_compute_forward_flash_attn_back(), ggml_compute_forward_flash_attn_back_f32(), ggml_compute_forward_flash_attn_f16() (+28 more)

### Community 9 - "dependencies"
Cohesion: 0.04
Nodes (40): ggml_log_callback, ggml_log_level, mt19937, fill_sin_cos_table(), kv_cache_free(), to_timestamp(), whisper_allocr_free(), whisper_allocr_size() (+32 more)
...
Cohesion: 0.32
Nodes (16): ggml_blck_size(), ggml_compute_forward_dup_bytes(), ggml_compute_forward_dup_f16(), ggml_compute_forward_dup_f32(), ggml_compute_forward_dup_same_cont(), ggml_compute_forward_get_rows_back(), ggml_compute_forward_get_rows_back_f32(), ggml_compute_forward_get_rows_back_f32_f16() (+8 more)

### Community 23 - "Context"
Cohesion: 0.19
Nodes (16): ggml_compute_forward_out_prod(), ggml_compute_forward_out_prod_f32(), ggml_compute_forward_out_prod_q_f32(), ggml_new_f32(), ggml_new_i32(), ggml_scratch_load(), ggml_scratch_save(), ggml_set_f32() (+8 more)

### Community 24 - "String"
Cohesion: 0.16
Nodes (14): ggml_get_f32_1d(), ggml_get_f32_nd(), ggml_get_i32_1d(), ggml_get_i32_nd(), ggml_graph_dump_dot(), ggml_graph_dump_dot_node_edge(), ggml_graph_find(), ggml_graph_get_parent() (+6 more)

### Community 25 - "View"
Cohesion: 0.15
Nodes (13): ggml_compute_forward_get_rows(), ggml_compute_forward_get_rows_f16(), ggml_compute_forward_get_rows_f32(), ggml_compute_forward_repeat(), ggml_compute_forward_repeat_back(), ggml_compute_forward_repeat_back_f32(), ggml_compute_forward_repeat_f16(), ggml_compute_forward_repeat_f32() (+5 more)

### Community 26 - "ggml_compute_forward"
Cohesion: 0.05
Nodes (46): ggml_compute_forward(), ggml_compute_forward_acc(), ggml_compute_forward_add_rel_pos(), ggml_compute_forward_add_rel_pos_f32(), ggml_compute_forward_argmax(), ggml_compute_forward_argmax_f32(), ggml_compute_forward_argsort(), ggml_compute_forward_argsort_f32() (+38 more)

### Community 27 - "ggml-alloc.c"
Cohesion: 0.06
Nodes (69): function, ggml_allocr_t, ggml_gallocr_t, jfloatArray, jlong, JNIEnv, JNIEXPORT, jobject (+61 more)

### Community 28 - "ggml_are_same_shape"
Cohesion: 0.05
Nodes (66): ggml_add_cast(), ggml_add_cast_impl(), ggml_are_same_shape(), ggml_compute_forward_abs(), ggml_compute_forward_abs_f32(), ggml_compute_forward_acc_f32(), ggml_compute_forward_add(), ggml_compute_forward_add1() (+58 more)

### Community 29 - "ggml-backend.c"
Cohesion: 0.12
Nodes (40): ggml_backend_buffer_context_t, ggml_backend_init_fn, ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_buffer_clear(), ggml_backend_buffer_get_alignment(), ggml_backend_buffer_get_alloc_size(), ggml_backend_buffer_get_base() (+32 more)
...
### Community 31 - "vector"
Cohesion: 0.15
Nodes (27): pair, decode_utf8(), whisper_grammar, whisper_grammar_accept(), whisper_grammar_accept_token(), whisper_grammar_advance_stack(), whisper_grammar_candidate, code_points (+19 more)
...
Cohesion: 0.10
Nodes (32): get_signal_energy(), sample_to_timestamp(), should_split_on_word(), timestamp_to_sample(), whisper_batch_prep_legacy(), whisper_decode(), whisper_decode_with_state(), whisper_exp_compute_token_level_timestamps() (+24 more)

### Community 34 - "ggml_dup_tensor"
Cohesion: 0.10
Nodes (38): ggml_argmax(), ggml_argsort(), ggml_calc_pool_output_size(), ggml_can_mul_mat(), ggml_concat(), ggml_conv_transpose_1d(), ggml_conv_transpose_2d_p0(), ggml_cross_entropy_loss() (+30 more)
...
Cohesion: 0.09
Nodes (27): ggml_float, __avx_f32cx8_load(), __avx_f32cx8_store(), ggml_fp16_t, __m128, __m256, ggml_compute_forward_conv_transpose_1d(), ggml_compute_forward_conv_transpose_1d_f16_f32() (+19 more)

### Community 37 - "ggml_backend_t"
Cohesion: 0.12
Nodes (25): ggml_backend_graph_plan_t, ggml_type_traits_t, ggml_backend_t, ggml_backend_cpu_buffer_type_supports_backend(), ggml_backend_cpu_free(), ggml_backend_cpu_graph_compute(), ggml_backend_cpu_graph_plan_compute(), ggml_backend_cpu_graph_plan_create() (+17 more)

### Community 38 - "ggml_compute_forward_unary"
Cohesion: 0.18
Nodes (11): ggml_abs_inplace(), ggml_elu_inplace(), ggml_gelu_inplace(), ggml_gelu_quick_inplace(), ggml_neg_inplace(), ggml_relu_inplace(), ggml_sgn_inplace(), ggml_silu_inplace() (+3 more)
...
Cohesion: 0.15
Nodes (21): ggml_custom1_op_t, ggml_custom2_op_t, ggml_alibi(), ggml_can_repeat_rows(), ggml_clamp(), ggml_cpy_impl(), ggml_diag_mask_zero_impl(), ggml_is_padded_1d() (+13 more)
...
Cohesion: 0.20
Nodes (22): ggml_add(), ggml_build_forward_expand(), ggml_cpy(), ggml_element_size(), ggml_gelu(), ggml_mul(), ggml_mul_mat(), ggml_new_tensor_2d() (+14 more)

### Community 43 - "gguf_get_n_kv"
Cohesion: 0.11
Nodes (20): gguf_find_key(), gguf_get_arr_data(), gguf_get_arr_n(), gguf_get_arr_str(), gguf_get_arr_type(), gguf_get_key(), gguf_get_kv_type(), gguf_get_n_kv() (+12 more)

### Community 44 - "sched_split_graph"
Cohesion: 0.21
Nodes (21): ggml_backend_sched_t, ggml_tallocr_t, fmt_size(), get_allocr_backend(), get_buffer_backend(), ggml_backend_buft_supports_backend(), ggml_backend_name(), ggml_backend_sched_get_buffer() (+13 more)
...
Cohesion: 0.19
Nodes (16): ggml_tensor, ggml_cont_1d(), ggml_cont_2d(), ggml_cont_3d(), ggml_cont_4d(), ggml_conv_1d(), ggml_conv_2d(), ggml_conv_2d_s1_ph() (+8 more)

### Community 48 - "ggml_new_graph_custom"
Cohesion: 0.17
Nodes (17): ggml_add1(), ggml_add1_impl(), ggml_add1_inplace(), ggml_add1_or_set(), ggml_build_backward_expand(), ggml_build_backward_gradient_checkpointing(), ggml_graph_cpy(), ggml_graph_dup() (+9 more)

### Community 49 - "ggml_init"
Cohesion: 0.28
Nodes (9): FILE, ggml_graph_dump_dot_leaf_edge(), ggml_set_name(), ggml_set_no_alloc(), gguf_fread_el(), gguf_fread_str(), gguf_free(), gguf_get_val_u32() (+1 more)
...
Cohesion: 0.07
Nodes (41): ggml_type, ggml_conv_1d_ph(), ggml_ftype_to_ggml_type(), ggml_init(), ggml_setup_op_has_task_pass(), ggml_time_init(), ggml_time_us(), ggml_graph_compute_helper() (+33 more)
...
Cohesion: 0.22
Nodes (9): ggml_abs(), ggml_elu(), ggml_gelu_quick(), ggml_relu(), ggml_sgn(), ggml_silu(), ggml_step(), ggml_tanh() (+1 more)

### Community 61 - "size"
Cohesion: 0.12
Nodes (22): dft(), fft(), hann_window(), log_mel_spectrogram(), log_mel_spectrogram_worker_thread(), tokenize(), whisper_filters, n_fft (+14 more)
...
Cohesion: 0.19
Nodes (14): ggml_backend_buffer_t, ggml_backend_buffer_type_t, ggml_backend_t, ggml_backend_alloc_ctx_tensors(), ggml_backend_alloc_ctx_tensors_from_buft(), ggml_backend_alloc_buffer(), ggml_backend_buft_alloc_buffer(), ggml_backend_buft_get_alignment() (+6 more)

### Community 64 - "ggml_can_repeat"
Cohesion: 0.33
Nodes (6): ggml_add_impl(), ggml_add_or_set(), ggml_can_repeat(), ggml_div(), ggml_div_impl(), ggml_mul_impl()
...
Cohesion: 0.17
Nodes (12): ggml_backend_eval_callback, ggml_tallocr_free(), ggml_backend_buffer_free(), ggml_backend_compare_graph_backend(), ggml_backend_graph_copy(), ggml_backend_graph_copy_free(), ggml_backend_sched_free(), ggml_dup_tensor_layout() (+4 more)

### Community 67 - "whisper_bench_ggml_mul_mat_str"
Cohesion: 0.28
Nodes (9): ggml_graph_import(), ggml_graph_nbytes(), ggml_graph_overhead(), ggml_graph_overhead_custom(), ggml_hash_size(), ggml_new_graph(), ggml_new_graph_custom(), ggml_top_k() (+1 more)
...
### Community 71 - "ggml_nbytes"
Cohesion: 0.29
Nodes (10): ggml_are_same_layout(), ggml_backend_cpu_buffer_cpy_tensor_from(), ggml_backend_cpu_buffer_cpy_tensor_to(), ggml_backend_tensor_copy(), ggml_backend_tensor_get(), ggml_backend_tensor_get_async(), ggml_backend_tensor_set(), ggml_backend_tensor_set_async() (+2 more)
...
Cohesion: 0.12
Nodes (17): block_q4_0, block_q5_0, block_q8_0, ggml_fp32_to_fp16_row(), ggml_quantize_chunk(), ggml_quantize_q4_0(), ggml_quantize_q5_0(), ggml_quantize_q8_0() (+9 more)
...
### Community 83 - "ggml_map_custom1_impl"
Cohesion: 0.40
Nodes (5): gguf_find_tensor(), gguf_get_n_tensors(), gguf_get_tensor_name(), gguf_set_tensor_data(), gguf_set_tensor_type()

### Community 84 - "ggml_map_custom2_impl"
Cohesion: 0.50
Nodes (4): clear_numa_thread_affinity(), ggml_is_numa(), ggml_numa_init(), set_numa_thread_affinity()

### Community 85 - "ggml_map_custom3_impl"
Cohesion: 0.83
Nodes (4): ggml_custom3_op_t, ggml_map_custom3(), ggml_map_custom3_impl(), ggml_map_custom3_inplace()

### Community 86 - "ggml_soft_max_back_impl"
Cohesion: 0.20
Nodes (12): ggml_acc_impl(), ggml_acc_or_set(), ggml_compute_backward(), ggml_cont(), ggml_cont_impl(), ggml_cross_entropy_loss_back(), ggml_neg(), ggml_silu_back() (+4 more)

### Community 88 - "ggml_add_rel_pos_impl"
Cohesion: 0.67
Nodes (3): ggml_add_rel_pos(), ggml_add_rel_pos_impl(), ggml_add_rel_pos_inplace()

### Community 89 - "ggml_build_forward_impl"
Cohesion: 0.67
Nodes (3): ggml_build_forward_impl(), ggml_graph_clear(), ggml_visit_parents()

### Community 90 - "ggml_diag_mask_inf_impl"
Cohesion: 0.67
Nodes (3): ggml_diag_mask_inf(), ggml_diag_mask_inf_impl(), ggml_diag_mask_inf_inplace()

### Community 91 - "ggml_dup_impl"
Cohesion: 0.67
Nodes (3): ggml_dup(), ggml_dup_impl(), ggml_dup_inplace()

### Community 92 - "ggml_group_norm_impl"
Cohesion: 0.67
Nodes (3): ggml_group_norm(), ggml_group_norm_impl(), ggml_group_norm_inplace()

### Community 93 - "ggml_log_impl"
Cohesion: 0.67
Nodes (3): ggml_log(), ggml_log_impl(), ggml_log_inplace()

### Community 94 - "ggml_rms_norm_impl"
Cohesion: 0.67
Nodes (3): ggml_rms_norm(), ggml_rms_norm_impl(), ggml_rms_norm_inplace()

### Community 95 - "ggml_sqr_impl"
Cohesion: 0.67
Nodes (3): ggml_sqr(), ggml_sqr_impl(), ggml_sqr_inplace()

### Community 96 - "ggml_sqrt_impl"
Cohesion: 0.67
Nodes (3): ggml_sqrt(), ggml_sqrt_impl(), ggml_sqrt_inplace()

### Community 97 - "ggml_sub_impl"
Cohesion: 0.67
...
- **Why does `whisper_state` connect `whisper_state` to `string`, `whisper_full_with_state`, `whisper_decoder`, `dependencies`, `ggml_compute_backward`, `whisper_kv_cache`, `whisper_allocr`, `whisper_batch`, `whisper_context`, `ggml-alloc.c`, `size`, `vector`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `whisper_build_graph_decoder()` connect `ggml_compute_backward` to `whisper_state`, `ggml_dup_tensor`, `WhisperEngine`, `whisper_bench_ggml_mul_mat_str`, `ggml_nbytes`, `dependencies`, `ggml_format_name`, `whisper_batch`, `App.tsx`, `whisper_context`, `ggml-alloc.c`, `size`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `whisper_build_graph_encoder()` connect `ggml_compute_backward` to `whisper_state`, `ggml_dup_tensor`, `WhisperEngine`, `whisper_bench_ggml_mul_mat_str`, `ggml_view_tensor`, `dependencies`, `ggml_format_name`, `ggml_soft_max_back_impl`, `whisper_context`, `size`?**
